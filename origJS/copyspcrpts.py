...
var hailArray = []	
function initialize() {
	var LatLng = {lat: 35.616, lng: 150.644};
    var myOptions = {
		zoom: 7,
		center: LatLng,
...
var icons = new Array();
icons["red"] = {
	  url: "www.blizzard.atms.unca.edu/~cgodfrey/advcomp/maps/images/marker_red.png",
//icons["red"] = new google.maps.MarkerImage("mark_red.png",  
...
function getMarkerImage(iconColor) {
   ...
   if (!icons[iconColor]) {
      icons[iconColor] = new google.maps.MarkerImage("mark_"+ iconColor +".png",
...
java.write('''
 ...
 function setMarkers(map, locations, type) {
  ...
  for (var i = 0; i < locations.length; i++) {
    ...
    var LatLng = new google.maps.LatLng(report[0], report[1]);
    var marker = createMarker(map,LatLng,report[2],report[3],report[4],type);
  }
}
